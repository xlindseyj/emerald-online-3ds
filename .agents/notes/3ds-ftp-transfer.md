...
- Protocol: FTP
- Default IP: `<3ds-ip>` (confirm with the user — it can change)
- Port: `5000`
...
```sh
curl -T release/emerald-online-3ds.cia ftp://<3ds-ip>:5000/cias/emerald-online-3ds.cia --user anonymous:
curl -T release/emerald-online-3ds.3dsx ftp://<3ds-ip>:5000/3ds/emerald-online-3ds/emerald-online-3ds.3dsx --user anonymous:
```

## Verify the copy

```sh
curl --user anonymous: ftp://<3ds-ip>:5000/cias/
curl --user anonymous: ftp://<3ds-ip>:5000/3ds/emerald-online-3ds/
```
